...
export const createTodolistThunkCreator = (TodolistTitle: string) => (dispatch: Dispatch) => {
...
export const changeTodolistTitleThunkCreator = (todolistId: string, todolistTitle: string) => (dispatch: Dispatch) => {
